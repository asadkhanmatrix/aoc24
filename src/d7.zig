...
fn worksPart1(t: i64, c: i64, r: []i64) bool {
    if (r.len == 0) return t == c;
    if (c > t) return false;
    return worksPart1(t, c + r[0], r[1..]) or worksPart1(t, c * r[0], r[1..]);
}

fn concat(allocator: std.mem.Allocator, a: i64, b: i64) !i64 {
    ...
    return try std.fmt.parseInt(i64, res, 10);
}

fn worksPart2(allocator: std.mem.Allocator, t: i64, c: i64, r: []i64) !bool {
    if (r.len == 0) return t == c;
    if (c > t) return false;
